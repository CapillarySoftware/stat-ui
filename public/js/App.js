...
this.returnEff = function(x){
  return function(){
    return new x;
  };
};
this.InputLinker = function(p, a){
  console.log("--->", a);
  return returnEff(PS.Data_Maybe.Nothing);
};
...
PS.Prelude = (function () {
    ...
    var semigroupUnit = function () {
        return new Semigroup(function (_99) {
    ...
    var ordUnit = function () {
        return new Ord(eqUnit, function (_93) {
            return function (_94) {
                return EQ.value;
            };
        });
    ...
    var ordBoolean = function () {
        return new Ord(eqBoolean, function (_95) {
            return function (_96) {
                if (!_95 && !_96) {
                    return EQ.value;
                };
    ...
    var $less = function (__dict_Ord_10) {
        return function (a1) {
            return function (a2) {
                var _492 = compare(__dict_Ord_10)(a1)(a2);
    ...
    var $less$eq = function (__dict_Ord_11) {
        return function (a1) {
            return function (a2) {
                var _493 = compare(__dict_Ord_11)(a1)(a2);
                if (_493 instanceof GT) {
                    return false;
                };
                return true;
            };
    ...
    var $greater = function (__dict_Ord_12) {
        return function (a1) {
            return function (a2) {
                var _494 = compare(__dict_Ord_12)(a1)(a2);
                if (_494 instanceof GT) {
                    return true;
                };
                return false;
            };
    ...
    var $greater$eq = function (__dict_Ord_13) {
        return function (a1) {
            return function (a2) {
                var _495 = compare(__dict_Ord_13)(a1)(a2);
                if (_495 instanceof LT) {
                    return false;
                };
                return true;
            };
    ...
    var ordArray = function (__dict_Ord_9) {
        return new Ord(function () {
            ...
            return function (_98) {
                ...
                if (_97.length >= 1) {
                    var _502 = _97.slice(1);
                    if (_98.length >= 1) {
                        var _500 = _98.slice(1);
                        var _498 = compare(__dict_Ord_9)(_97[0])(_98[0]);
                        if (_498 instanceof EQ) {
                            return compare(ordArray(__dict_Ord_9))(_502)(_500);
                        };
                        return _498;
                    };
                };
...
PS.Data_Eq = (function () {
    ...
    var liftRef = function (_101) {
        return function (_102) {
            return function (_103) {
                return _101(_102)(_103);
            };
        };
    };
    var functorRef = function () {
        return new Prelude.Functor(function (_104) {
...
PS.Network_SocketIO = (function () {
  ...
  ;
    ...
    var functorResponse = function () {
        return new Prelude.Functor(function (_106) {
            return function (_107) {
                return new Response(_106(_107.value0));
            };
        });
    };
    var emit = function (s) {
    ...
    var applyResponse = function () {
        return new Prelude.Apply(function (_108) {
            return function (_109) {
                return Prelude["<$>"](functorResponse())(_108.value0)(_109);
            };
        }, functorResponse);
    };
    var bindResponse = function () {
        return new Prelude.Bind(function (_110) {
    ...
    var replicateM = function (__dict_Monad_26) {
        return function (_114) {
            return function (_115) {
                ...
                return Prelude[">>="](__dict_Monad_26["__superclass_Prelude.Bind_1"]())(_115)(function (_4) {
                    return Prelude[">>="](__dict_Monad_26["__superclass_Prelude.Bind_1"]())(replicateM(__dict_Monad_26)(_114 - 1)(_115))(function (_3) {
        ...
        return function (_116) {
            return function (_117) {
                return function (_118) {
                    if (_118.length === 0) {
                        return Prelude["return"](__dict_Monad_27)(_117);
                    };
                    if (_118.length >= 1) {
                        var _537 = _118.slice(1);
                        return Prelude[">>="](__dict_Monad_27["__superclass_Prelude.Bind_1"]())(_116(_117)(_118[0]))(function (a$prime) {
                            return foldM(__dict_Monad_27)(_116)(a$prime)(_537);
                        });
                    };
                    throw new Error("Failed pattern match");
                };
...
PS.Control_Monad_Identity = (function () {
    ...
    var comonadIdentity = function () {
        return new Control_Comonad.Comonad(extendIdentity, function (_126) {
            return _126;
        });
    };
    var applyIdentity = function () {
        return new Prelude.Apply(function (_124) {
            return function (_125) {
                return Identity.create(_124(_125));
            };
        }, functorIdentity);
    };
...
PS.Data_Either = (function () {
        ...
        return function (__dict_Show_64) {
            return new Prelude.Show(function (_138) {
                if (_138 instanceof Left) {
                    return "Left (" + (Prelude.show(__dict_Show_63)(_138.value0) + ")");
                };
                if (_138 instanceof Right) {
                    return "Right (" + (Prelude.show(__dict_Show_64)(_138.value0) + ")");
                };
                throw new Error("Failed pattern match");
            });
        };
            ...
            return new Prelude.Eq(function (a) {
                ...
                return function (_140) {
                    if (_139 instanceof Left && _140 instanceof Left) {
                        return Prelude["=="](__dict_Eq_67)(_139.value0)(_140.value0);
                    };
            ...
            return new Prelude.Ord(function () {
                ...
                return function (_142) {
                    if (_141 instanceof Left && _142 instanceof Left) {
                        return Prelude.compare(__dict_Ord_65)(_141.value0)(_142.value0);
                    };
    ...
    var applyEither = function () {
        return new Prelude.Apply(function (_134) {
    ...
    var altEither = function () {
        return new Control_Alt.Alt(function (_136) {
...
PS.Data_Maybe = (function () {
    ...
    var showMaybe = function (__dict_Show_69) {
        return new Prelude.Show(function (_158) {
            if (_158 instanceof Just) {
                return "Just (" + (Prelude.show(__dict_Show_69)(_158.value0) + ")");
            };
        ...
        return new Prelude.Semigroup(function (_156) {
            return function (_157) {
                ...
                if (_156 instanceof Just && _157 instanceof Just) {
                    return new Just(Prelude["<>"](__dict_Semigroup_70)(_156.value0)(_157.value0));
                };
                throw new Error("Failed pattern match");
            };
        });
    ...
    var extendMaybe = function () {
        return new Control_Extend.Extend(function (_154) {
        ...
        return new Prelude.Eq(function (a) {
            ...
            return function (_160) {
                ...
                if (_159 instanceof Just && _160 instanceof Just) {
                    return Prelude["=="](__dict_Eq_72)(_159.value0)(_160.value0);
                };
                return false;
            };
        });
        ...
        return new Prelude.Ord(function () {
            ...
            return function (_162) {
                if (_161 instanceof Just && _162 instanceof Just) {
                    return Prelude.compare(__dict_Ord_71)(_161.value0)(_162.value0);
                };
    ...
    var bindMaybe = function () {
        return new Prelude.Bind(function (_152) {
...
PS.Data_Array = (function () {
    ...
    var tail = function (_165) {
        if (_165.length >= 1) {
            ...
            return new Data_Maybe.Just(_611);
        };
    ...
    var sortBy = function (comp) {
        return function (xs) {
            var comp$prime = function (x) {
                return function (y) {
                    var _617 = comp(x)(y);
                    if (_617 instanceof Prelude.GT) {
                        return 1;
                    };
                    if (_617 instanceof Prelude.EQ) {
                        return 0;
                    };
                    if (_617 instanceof Prelude.LT) {
                        return -1;
                    };
                    throw new Error("Failed pattern match");
                };
    ...
    var last = function (__copy__164) {
        ...
        tco: while (true) {
            if (_164.length >= 1) {
                var _625 = _164.slice(1);
                if (_625.length === 0) {
                    return new Data_Maybe.Just(_164[0]);
                };
            };
            if (_164.length >= 1) {
                var _627 = _164.slice(1);
                _164 = _627;
                continue tco;
            };
            return Data_Maybe.Nothing.value;
            ...
            return function (__copy__179) {
                return function (__copy__180) {
                    ...
                    tco: while (true) {
                        ...
                        if (_180.length >= 1) {
                            var _639 = _180.slice(1);
                            var sp = span(_179(_180[0]))(_639);
    ...
    var deleteBy = function (_168) {
        return function (_169) {
            return function (_170) {
                ...
                var _643 = findIndex(_168(_169))(_170);
                if (_643 < 0) {
                    return _170;
                };
                return deleteAt(_643)(1)(_170);
            };
        };
    };
                ...
                var go = function (__copy__176) {
                    return function (__copy__177) {
                        ...
                        tco: while (true) {
                            ...
                            if (_177.length >= 1) {
                                var _647 = _177.slice(1);
                                var __tco__176 = $$delete(__dict_Eq_81)(_177[0])(_176);
                                _176 = __tco__176;
                                _177 = _647;
                                continue tco;
                            };
...
PS.Data_Foreign_Index = (function () {
    ...
    var hasPropertyImpl = function (_190) {
        return function (_191) {
            ...
            if (Data_Foreign.typeOf(_191) === "object" || Data_Foreign.typeOf(_191) === "function") {
                return unsafeHasProperty(_190, _191);
            };
            return false;
        };
    };
    ...
    var hasOwnPropertyImpl = function (_188) {
        return function (_189) {
            if (Data_Foreign.isNull(_189)) {
                return false;
            };
            if (Data_Foreign.isUndefined(_189)) {
                return false;
            };
            if (Data_Foreign.typeOf(_189) === "object" || Data_Foreign.typeOf(_189) === "function") {
                return unsafeHasOwnProperty(_188, _189);
            };
            return false;
        };
    };
...
PS.Data_Foreign_Keys = (function () {
    ...
    var keys = function (_192) {
        ...
        if (Data_Foreign.typeOf(_192) === "object") {
            return Data_Either.Right.create(unsafeKeys(_192));
        };
        return Data_Either.Left.create(new Data_Foreign.TypeMismatch("object", Data_Foreign.typeOf(_192)));
    };
    return {
        keys: keys
    };
...
PS.Data_Foreign_Null = (function () {
    ...
    var runNull = function (_193) {
        return _193;
    };
    var readNull = function (_194) {
        return function (_195) {
            if (Data_Foreign.isNull(_195)) {
                return Prelude.pure(Data_Either.applicativeEither())(Data_Maybe.Nothing.value);
            };
            return Prelude["<$>"](Data_Either.functorEither())(Prelude["<<<"](Prelude.semigroupoidArr())(Null.create)(Data_Maybe.Just.create))(_194(_195));
        };
    };
    return {
        Null: Null, 
...
PS.Data_Foreign_NullOrUndefined = (function () {
    ...
    var runNullOrUndefined = function (_196) {
        return _196;
    };
    var readNullOrUndefined = function (_197) {
        return function (_198) {
            if (Data_Foreign.isNull(_198) || Data_Foreign.isUndefined(_198)) {
                return Prelude.pure(Data_Either.applicativeEither())(Data_Maybe.Nothing.value);
            };
            return Prelude["<$>"](Data_Either.functorEither())(Prelude["<<<"](Prelude.semigroupoidArr())(NullOrUndefined.create)(Data_Maybe.Just.create))(_197(_198));
        };
    };
    return {
...
PS.Data_Foreign_Undefined = (function () {
    ...
    var runUndefined = function (_199) {
        return _199;
    };
    var readUndefined = function (_200) {
        return function (_201) {
            if (Data_Foreign.isUndefined(_201)) {
                return Prelude.pure(Data_Either.applicativeEither())(Data_Maybe.Nothing.value);
            };
            return Prelude["<$>"](Data_Either.functorEither())(Prelude["<<<"](Prelude.semigroupoidArr())(Undefined.create)(Data_Maybe.Just.create))(_200(_201));
        };
    };
    return {
        Undefined: Undefined, 
...
PS.Data_Array_Unsafe = (function () {
    ...
    var head = function (_203) {
        if (_203.length >= 1) {
            var _680 = _203.slice(1);
            return _203[0];
        };
        throw new Error("Failed pattern match");
    };
...
PS.Control_Reactive = (function () {
    ...
    var subscribeComputed = function (_206) {
        return function (_207) {
            return _206.value0.subscribe(_207);
        };
    };
    var showArrayChange = function (__dict_Show_84) {
        return new Prelude.Show(function (_210) {
            if (_210 instanceof Inserted) {
                return "Inserted " + (Prelude.show(__dict_Show_84)(_210.value0) + (" at " + Prelude.show(Prelude.showNumber())(_210.value1)));
            };
            if (_210 instanceof Updated) {
                return "Updated " + (Prelude.show(Prelude.showNumber())(_210.value1) + (" to " + Prelude.show(__dict_Show_84)(_210.value0)));
            };
            if (_210 instanceof Removed) {
                return "Removed at index " + Prelude.show(Prelude.showNumber())(_210.value0);
            };
            throw new Error("Failed pattern match");
        });
    };
    ...
    var readComputed = function (_205) {
        return _205.value0.read;
    };
    ...
    var applyComputed = function () {
        return new Prelude.Apply(function (_213) {
            return function (_214) {
                return new Computed({
                    read: function __do() {
                        var _16 = _213.value0.read();
                        var _15 = _214.value0.read();
                        return _16(_15);
                    }, 
                    subscribe: function (ob) {
                        return function __do() {
                            var _20 = _213.value0.subscribe(function (f$prime) {
                                return function __do() {
                                    var _17 = _214.value0.read();
                                    return ob(f$prime(_17))();
                                };
                            })();
                            var _19 = _214.value0.subscribe(function (x$prime) {
                                return function __do() {
                                    var _18 = _213.value0.read();
    ...
    var bindComputed = function () {
        return new Prelude.Bind(function (_211) {
            return function (_212) {
                return new Computed({
                    read: function __do() {
                        var _7 = _211.value0.read();
                        return (function () {
                            var _710 = _212(_7);
                            return _710.value0.read;
                        })()();
                    }, 
                    subscribe: function (ob) {
                        return function __do() {
                            var _14 = _211.value0.read();
                            return (function () {
                                var _713 = _212(_14);
                                return function __do() {
                                    var _13 = _713.value0.subscribe(ob)();
                                    var _12 = Control_Monad_Eff_Ref_Unsafe.unsafeRunRef(Control_Monad_Eff_Ref.newRef(_13))();
                                    var _11 = _211.value0.subscribe(function (a$prime) {
                                        return function __do() {
                                            var _9 = Control_Monad_Eff_Ref_Unsafe.unsafeRunRef(Control_Monad_Eff_Ref.readRef(_12))();
                                            _9.value0();
                                            var _717 = _212(a$prime);
                                            Prelude[">>="](Control_Monad_Eff.bindEff())(_717.value0.read)(ob)();
                                            var _8 = _717.value0.subscribe(ob)();
...
PS.Control_Reactive_Event = (function () {
    ...
    var unwrapEventName = function (_220) {
        return _220.value0;
    };
    var unwrapEventDetail = function (_219) {
        return _219.value1.detail;
    };
    ...
    var eventNMap = function (_217) {
        return function (_218) {
            return new Event(_217(_218.value0), _218.value1);
        };
    };
    var eventDMap = function (_215) {
        return function (_216) {
            return Event.create(_216.value0)((function () {
                var _738 = {};
                for (var _739 in _216.value1) {
                    if (_216.value1.hasOwnProperty(_739)) {
                        _738[_739] = _216.value1[_739];
                    };
                };
                _738.detail = _215(_216.value1.detail);
                return _738;
            })());
        };
    };
    var emitOn = function (_221) {
        return function (_222) {
            return emitOn_(_221.value0)(_221.value1)(_222);
        };
    };
...
PS.Data_Monoid_All = (function () {
    ...
    var showAll = function () {
        return new Prelude.Show(function (_228) {
            return "All (" + (Prelude.show(Prelude.showBoolean())(_228) + ")");
        });
    };
    var semigroupAll = function () {
        return new Prelude.Semigroup(function (_229) {
            return function (_230) {
                return _229 && _230;
            };
        });
    };
    var runAll = function (_223) {
        return _223;
    };
...
PS.Data_Monoid_Any = (function () {
    ...
    var showAny = function () {
        return new Prelude.Show(function (_236) {
            return "Any (" + (Prelude.show(Prelude.showBoolean())(_236) + ")");
        });
    };
...
PS.Data_Monoid_Dual = (function () {
    ...
    var showDual = function (__dict_Show_85) {
        return new Prelude.Show(function (_246) {
            return "Dual (" + (Prelude.show(__dict_Show_85)(_246) + ")");
        });
    };
    var semigroupDual = function (__dict_Semigroup_86) {
        return new Prelude.Semigroup(function (_247) {
            return function (_248) {
                return Prelude["<>"](__dict_Semigroup_86)(_248)(_247);
            };
        });
    };
    var runDual = function (_239) {
        return _239;
    };
    ...
    var ordDual = function (__dict_Ord_87) {
        return new Prelude.Ord(function () {
            ...
            return function (_245) {
                return Prelude.compare(__dict_Ord_87)(_244)(_245);
            };
        });
    };
    return {
    ...
    var semigroupEndo = function () {
        return new Prelude.Semigroup(function (_250) {
            return function (_251) {
                return Prelude["<<<"](Prelude.semigroupoidArr())(_250)(_251);
            };
        });
    };
    var runEndo = function (_249) {
        return _249;
    };
...
PS.Data_Monoid_Product = (function () {
    ...
    var showProduct = function () {
        return new Prelude.Show(function (_259) {
            return "Product (" + (Prelude.show(Prelude.showNumber())(_259) + ")");
        });
    };
    ...
    var ordProduct = function () {
        return new Prelude.Ord(eqProduct, function (_257) {
...
PS.Data_Monoid_Sum = (function () {
    ...
    var showSum = function () {
        return new Prelude.Show(function (_269) {
            return "Sum (" + (Prelude.show(Prelude.showNumber())(_269) + ")");
        });
    };
    ...
    var ordSum = function () {
        return new Prelude.Ord(eqSum, function (_267) {
            return function (_268) {
                return Prelude.compare(Prelude.ordNumber())(_267)(_268);
            };
        });
    };
    return {
...
PS.Data_Tuple = (function () {
    ...
    var unzip = function (_276) {
        if (_276.length >= 1) {
            var _805 = _276.slice(1);
            var _799 = unzip(_805);
            return new Tuple(Prelude[":"]((_276[0]).value0)(_799.value0), Prelude[":"]((_276[0]).value1)(_799.value1));
        };
        if (_276.length === 0) {
            return new Tuple([  ], [  ]);
        };
    ...
    var uncurry = function (_274) {
        return function (_275) {
            return _274(_275.value0)(_275.value1);
        };
    };
    var swap = function (_277) {
        return new Tuple(_277.value1, _277.value0);
    };
    var snd = function (_273) {
        return _273.value1;
    };
    var showTuple = function (__dict_Show_90) {
        return function (__dict_Show_91) {
            return new Prelude.Show(function (_278) {
                return "Tuple (" + (Prelude.show(__dict_Show_90)(_278.value0) + (") (" + (Prelude.show(__dict_Show_91)(_278.value1) + ")")));
            });
        };
    };
        ...
        return function (__dict_Eq_96) {
            return new Prelude.Eq(function (t1) {
                ...
                return function (_280) {
                    return Prelude["=="](__dict_Eq_95)(_279.value0)(_280.value0) && Prelude["=="](__dict_Eq_96)(_279.value1)(_280.value1);
                };
            });
        };
    };
        ...
        return function (__dict_Ord_93) {
            return new Prelude.Ord(function () {
                ...
                return function (_282) {
                    var _834 = Prelude.compare(__dict_Ord_92)(_281.value0)(_282.value0);
                    if (_834 instanceof Prelude.EQ) {
                        return Prelude.compare(__dict_Ord_93)(_281.value1)(_282.value1);
                    };
                    return _834;
                };
            });
    ...
    var applyTuple = function (__dict_Semigroup_98) {
        return new Prelude.Apply(function (_285) {
            return function (_286) {
                return new Tuple(Prelude["<>"](__dict_Semigroup_98)(_285.value0)(_286.value0), _285.value1(_286.value1));
            };
        }, functorTuple);
    };
    var bindTuple = function (__dict_Semigroup_97) {
        return new Prelude.Bind(function (_287) {
            return function (_288) {
                var _847 = _288(_287.value1);
                return new Tuple(Prelude["<>"](__dict_Semigroup_97)(_287.value0)(_847.value0), _847.value1);
            };
        }, function () {
...
PS.Control_Monad_Error_Trans = (function () {
    ...
    var applyErrorT = function (__dict_Apply_113) {
        return new Prelude.Apply(function (_290) {
            return function (_291) {
                return ErrorT.create(Prelude["<*>"](__dict_Apply_113)(Prelude["<$>"](__dict_Apply_113["__superclass_Prelude.Functor_0"]())(Control_Apply.lift2(Data_Either.applyEither())(Prelude["$"]))(_290))(_291));
            };
        }, function () {
                ...
                return function (r) {
                    return function (s) {
                        return Prelude["<$>"](__dict_Functor_132)(function (see) {
                            var _884 = {};
                            for (var _885 in see) {
                                if (see.hasOwnProperty(_885)) {
                                    _884[_885] = see[_885];
                                };
                            };
                            _884.result = f(see.result);
                            return _884;
                        })(runRWST(m)(r)(s));
                    };
                };
        ...
        return function (__dict_Semigroup_138) {
            return new Prelude.Apply(function (f) {
                return function (m) {
                    return function (r) {
                        return function (s) {
                            return Prelude["<*>"](__dict_Apply_137)(Prelude["<$>"](__dict_Apply_137["__superclass_Prelude.Functor_0"]())(function (_293) {
                                return function (see) {
                                    var _887 = {};
                                    for (var _888 in see) {
                                        if (see.hasOwnProperty(_888)) {
                                            _887[_888] = see[_888];
                                        };
                                    };
                                    _887.result = _293.result(see.result);
                                    _887.log = Prelude["<>"](__dict_Semigroup_138)(_293.log)(see.log);
                                    return _887;
                                };
        ...
        return function (__dict_Semigroup_136) {
            return new Prelude.Bind(function (m) {
                return function (f) {
                    return function (r) {
                        return function (s) {
                            return Prelude[">>="](__dict_Bind_135)(runRWST(m)(r)(s))(function (_294) {
                                return Prelude["<$>"]((__dict_Bind_135["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(function (see$prime) {
                                    var _892 = {};
                                    for (var _893 in see$prime) {
                                        if (see$prime.hasOwnProperty(_893)) {
                                            _892[_893] = see$prime[_893];
                                        };
                                    };
                                    _892.log = Prelude["<>"](__dict_Semigroup_136)(_294.log)(see$prime.log);
                                    return _892;
                                })(runRWST(f(_294.result))(r)(_294.state));
                            });
                        };
                    };
                };
...
PS.Control_Monad_RWS = (function () {
        ...
        return function (__dict_Monoid_144) {
            return function (f) {
                return function (_) {
                    return function (s) {
                        var _900 = f(s);
                        return Prelude.pure(__dict_Applicative_143)(Control_Monad_RWS_Trans.mkSee(__dict_Monoid_144)(_900.value1)(_900.value0)(Data_Monoid.mempty(__dict_Monoid_144)));
                    };
                };
            };
        };
    ...
    var pass = function (__dict_Monad_149) {
        return function (m) {
            return function (r) {
                return function (s) {
                    return Prelude[">>="](__dict_Monad_149["__superclass_Prelude.Bind_1"]())(Control_Monad_RWS_Trans.runRWST(m)(r)(s))(function (_297) {
                        return Prelude.pure(__dict_Monad_149["__superclass_Prelude.Applicative_0"]())({
                            state: _297.state, 
                            result: _297.result.value0, 
                            log: _297.result.value1(_297.log)
                        });
                    });
                };
            };
    ...
    var listens = function (__dict_Monad_152) {
        return function (f) {
            return function (m) {
                return function (r) {
                    return function (s) {
                        return Prelude[">>="](__dict_Monad_152["__superclass_Prelude.Bind_1"]())(Control_Monad_RWS_Trans.runRWST(m)(r)(s))(function (_298) {
                            return Prelude.pure(__dict_Monad_152["__superclass_Prelude.Applicative_0"]())({
                                state: _298.state, 
                                result: new Data_Tuple.Tuple(_298.result, f(_298.log)), 
                                log: _298.log
                            });
                        });
                    };
    ...
    var listen = function (__dict_Monad_153) {
        return function (m) {
            return function (r) {
                return function (s) {
                    return Prelude[">>="](__dict_Monad_153["__superclass_Prelude.Bind_1"]())(Control_Monad_RWS_Trans.runRWST(m)(r)(s))(function (_296) {
                        return Prelude.pure(__dict_Monad_153["__superclass_Prelude.Applicative_0"]())({
                            state: _296.state, 
                            result: new Data_Tuple.Tuple(_296.result, _296.log), 
                            log: _296.log
                        });
                    });
                };
...
PS.Control_Monad_State_Trans = (function () {
    ...
    var execStateT = function (__dict_Monad_169) {
        return function (m) {
            return function (s) {
                return Prelude[">>="](__dict_Monad_169["__superclass_Prelude.Bind_1"]())(runStateT(m)(s))(function (_301) {
                    return Prelude["return"](__dict_Monad_169)(_301.value1);
                });
            };
        };
    };
    var evalStateT = function (__dict_Monad_170) {
        return function (m) {
            return function (s) {
                return Prelude[">>="](__dict_Monad_170["__superclass_Prelude.Bind_1"]())(runStateT(m)(s))(function (_300) {
                    return Prelude["return"](__dict_Monad_170)(_300.value0);
                });
            };
        };
    };
    ...
    var bindStateT = function (__dict_Monad_171) {
        return new Prelude.Bind(function (_303) {
            return function (_304) {
                return function (s) {
                    return Prelude[">>="](__dict_Monad_171["__superclass_Prelude.Bind_1"]())(_303(s))(function (_31) {
                        return runStateT(_304(_31.value0))(_31.value1);
                    });
                };
            };
        }, function () {
...
PS.Control_Monad_Writer_Trans = (function () {
    ...
    var functorWriterT = function (__dict_Functor_187) {
        return new Prelude.Functor(function (f) {
            return mapWriterT(Prelude["<$>"](__dict_Functor_187)(function (_305) {
                    ...
                    return WriterT.create((function () {
                        var k = function (_307) {
                            return function (_308) {
                                return new Data_Tuple.Tuple(_307.value0(_308.value0), Prelude["<>"](__dict_Monoid_190["__superclass_Prelude.Semigroup_0"]())(_307.value1)(_308.value1));
                            };
                        };
...
PS.Control_Monad_Error_Class = (function () {
    ...
    var monadErrorError = function (__dict_Error_208) {
        return new MonadError(function (_309) {
            return function (_310) {
                if (_309 instanceof Data_Either.Left) {
                    return _310(_309.value0);
                };
                if (_309 instanceof Data_Either.Right) {
                    return new Data_Either.Right(_309.value0);
                };
                throw new Error("Failed pattern match");
            };
...
PS.Data_Monoid_First = (function () {
    ...
    var showFirst = function (__dict_Show_293) {
        return new Prelude.Show(function (_318) {
            return "First (" + (Prelude.show(Data_Maybe.showMaybe(__dict_Show_293))(_318) + ")");
        });
    };
    ...
    var eqFirst = function (__dict_Eq_295) {
        return new Prelude.Eq(function (_314) {
            return function (_315) {
                return Prelude["/="](Data_Maybe.eqMaybe(__dict_Eq_295))(_314)(_315);
            };
        }, function (_312) {
            return function (_313) {
                return Prelude["=="](Data_Maybe.eqMaybe(__dict_Eq_295))(_312)(_313);
            };
        });
    };
    var ordFirst = function (__dict_Ord_294) {
        return new Prelude.Ord(function () {
            ...
            return function (_317) {
                return Prelude.compare(Data_Maybe.ordMaybe(__dict_Ord_294))(_316)(_317);
            };
        });
    };
    return {
...
PS.Data_Foldable = (function () {
        ...
        return new Foldable(function (__dict_Monoid_308) {
            ...
            return function (_342) {
                return function (_343) {
                    return _341(_342)(_343);
                };
            };
        }, function (_338) {
            return function (_339) {
                return function (_340) {
                    return _338(_340)(_339);
                };
            };
        });
    };
        ...
        return new Foldable(function (__dict_Monoid_310) {
            ...
            return function (_326) {
                return function (_327) {
                    if (_327 instanceof Data_Either.Left) {
                        return _326;
                    };
                    if (_327 instanceof Data_Either.Right) {
                        return _325(_326)(_327.value0);
                    };
                    throw new Error("Failed pattern match");
                };
            };
    ...
    var lookup = function (__dict_Eq_312) {
        return function (__dict_Foldable_313) {
            return function (a) {
                return function (f) {
                    return Data_Monoid_First.runFirst(foldMap(__dict_Foldable_313)(Data_Monoid_First.monoidFirst())(function (_321) {
                        return Prelude["=="](__dict_Eq_312)(a)(_321.value0) ? new Data_Maybe.Just(_321.value1) : Data_Maybe.Nothing.value;
                    })(f));
                };
            };
        };
    ...
    var find = function (__dict_Foldable_316) {
        return function (p) {
            return function (f) {
                var _1040 = foldMap(__dict_Foldable_316)(Data_Monoid.monoidArray())(function (x) {
                    return p(x) ? [ x ] : [  ];
                })(f);
                if (_1040.length >= 1) {
                    var _1042 = _1040.slice(1);
                    return new Data_Maybe.Just(_1040[0]);
                };
                if (_1040.length === 0) {
                    return Data_Maybe.Nothing.value;
                };
...
PS.Data_Map = (function () {
    ...
    var values = function (_364) {
        if (_364 instanceof Leaf) {
            return [  ];
        };
        if (_364 instanceof Two) {
            return Prelude["++"](Data_Array.semigroupArray())(values(_364.value0))(Prelude["++"](Data_Array.semigroupArray())([ _364.value2 ])(values(_364.value3)));
        };
        if (_364 instanceof Three) {
            return Prelude["++"](Data_Array.semigroupArray())(values(_364.value0))(Prelude["++"](Data_Array.semigroupArray())([ _364.value2 ])(Prelude["++"](Data_Array.semigroupArray())(values(_364.value3))(Prelude["++"](Data_Array.semigroupArray())([ _364.value5 ])(values(_364.value6)))));
        };
        throw new Error("Failed pattern match");
    };
    var toList = function (_362) {
        if (_362 instanceof Leaf) {
            return [  ];
        };
        if (_362 instanceof Two) {
            return Prelude["++"](Data_Array.semigroupArray())(toList(_362.value0))(Prelude["++"](Data_Array.semigroupArray())([ new Data_Tuple.Tuple(_362.value1, _362.value2) ])(toList(_362.value3)));
        };
        if (_362 instanceof Three) {
            return Prelude["++"](Data_Array.semigroupArray())(toList(_362.value0))(Prelude["++"](Data_Array.semigroupArray())([ new Data_Tuple.Tuple(_362.value1, _362.value2) ])(Prelude["++"](Data_Array.semigroupArray())(toList(_362.value3))(Prelude["++"](Data_Array.semigroupArray())([ new Data_Tuple.Tuple(_362.value4, _362.value5) ])(toList(_362.value6)))));
        };
        throw new Error("Failed pattern match");
    };
        ...
        return function (__dict_Show_325) {
            return function (_356) {
                ...
                if (_356 instanceof Two) {
                    return "Two (" + (showTree(__dict_Show_324)(__dict_Show_325)(_356.value0) + (") (" + (Prelude.show(__dict_Show_324)(_356.value1) + (") (" + (Prelude.show(__dict_Show_325)(_356.value2) + (") (" + (showTree(__dict_Show_324)(__dict_Show_325)(_356.value3) + ")")))))));
                };
                if (_356 instanceof Three) {
                    return "Three (" + (showTree(__dict_Show_324)(__dict_Show_325)(_356.value0) + (") (" + (Prelude.show(__dict_Show_324)(_356.value1) + (") (" + (Prelude.show(__dict_Show_325)(_356.value2) + (") (" + (showTree(__dict_Show_324)(__dict_Show_325)(_356.value3) + (") (" + (Prelude.show(__dict_Show_324)(_356.value4) + (") (" + (Prelude.show(__dict_Show_325)(_356.value5) + (") (" + (showTree(__dict_Show_324)(__dict_Show_325)(_356.value6) + ")")))))))))))));
                };
                throw new Error("Failed pattern match");
            };
        };
        ...
        return function (__copy__358) {
            return function (__copy__359) {
                ...
                tco: while (true) {
                    ...
                    if (_359 instanceof Two && Prelude["=="](__dict_Ord_328["__superclass_Prelude.Eq_0"]())(_358)(_359.value1)) {
                        return new Data_Maybe.Just(_359.value2);
                    };
                    if (_359 instanceof Two && Prelude["<"](__dict_Ord_328)(_358)(_359.value1)) {
                        var __tco___dict_Ord_328 = __dict_Ord_328;
                        var __tco__358 = _358;
                        var __tco__359 = _359.value0;
                    ...
                    if (_359 instanceof Two) {
                        var __tco___dict_Ord_328 = __dict_Ord_328;
                        var __tco__358 = _358;
                        var __tco__359 = _359.value3;
                        __dict_Ord_328 = __tco___dict_Ord_328;
                        _358 = __tco__358;
                        _359 = __tco__359;
                        continue tco;
                    };
                    if (_359 instanceof Three && Prelude["=="](__dict_Ord_328["__superclass_Prelude.Eq_0"]())(_358)(_359.value1)) {
                        return new Data_Maybe.Just(_359.value2);
                    };
                    if (_359 instanceof Three && Prelude["=="](__dict_Ord_328["__superclass_Prelude.Eq_0"]())(_358)(_359.value4)) {
                        return new Data_Maybe.Just(_359.value5);
                    };
                    if (_359 instanceof Three && Prelude["<"](__dict_Ord_328)(_358)(_359.value1)) {
                        var __tco___dict_Ord_328 = __dict_Ord_328;
                        var __tco__358 = _358;
                        var __tco__359 = _359.value0;
                        __dict_Ord_328 = __tco___dict_Ord_328;
                    ...
                    if (_359 instanceof Three && (Prelude["<"](__dict_Ord_328)(_359.value1)(_358) && Prelude["<="](__dict_Ord_328)(_358)(_359.value4))) {
                        var __tco___dict_Ord_328 = __dict_Ord_328;
                        var __tco__358 = _358;
                        var __tco__359 = _359.value3;
                        __dict_Ord_328 = __tco___dict_Ord_328;
    ...
    var keys = function (_363) {
        if (_363 instanceof Leaf) {
            return [  ];
        };
        if (_363 instanceof Two) {
            return Prelude["++"](Data_Array.semigroupArray())(keys(_363.value0))(Prelude["++"](Data_Array.semigroupArray())([ _363.value1 ])(keys(_363.value3)));
        };
        if (_363 instanceof Three) {
            return Prelude["++"](Data_Array.semigroupArray())(keys(_363.value0))(Prelude["++"](Data_Array.semigroupArray())([ _363.value1 ])(Prelude["++"](Data_Array.semigroupArray())(keys(_363.value3))(Prelude["++"](Data_Array.semigroupArray())([ _363.value4 ])(keys(_363.value6)))));
        };
        throw new Error("Failed pattern match");
    };
    var isEmpty = function (_357) {
    ...
    var functorMap = function () {
        return new Prelude.Functor(function (_365) {
            return function (_366) {
                if (_366 instanceof Leaf) {
                    return Leaf.value;
                };
                if (_366 instanceof Two) {
                    return new Two(Prelude["<$>"](functorMap())(_365)(_366.value0), _366.value1, _365(_366.value2), Prelude["<$>"](functorMap())(_365)(_366.value3));
                };
                if (_366 instanceof Three) {
                    return new Three(Prelude["<$>"](functorMap())(_365)(_366.value0), _366.value1, _365(_366.value2), Prelude["<$>"](functorMap())(_365)(_366.value3), _366.value4, _365(_366.value5), Prelude["<$>"](functorMap())(_365)(_366.value6));
                };
                throw new Error("Failed pattern match");
            };
        });
        ...
        return function (__copy__360) {
            return function (__copy__361) {
                ...
                tco: while (true) {
                    ...
                    if (_360.length >= 1) {
                        var _1160 = _360.slice(1);
                        if (_360[0] instanceof TwoLeft) {
                            var __tco___dict_Ord_330 = __dict_Ord_330;
                            var __tco__361 = new Two(_361, (_360[0]).value0, (_360[0]).value1, (_360[0]).value2);
                    ...
                    if (_360.length >= 1) {
                        var _1165 = _360.slice(1);
                        if (_360[0] instanceof TwoRight) {
                            var __tco___dict_Ord_330 = __dict_Ord_330;
                            var __tco__361 = new Two((_360[0]).value0, (_360[0]).value1, (_360[0]).value2, _361);
                            __dict_Ord_330 = __tco___dict_Ord_330;
                            _360 = _1165;
                            _361 = __tco__361;
                            continue tco;
                    ...
                    if (_360.length >= 1) {
                        var _1173 = _360.slice(1);
                        if (_360[0] instanceof ThreeLeft) {
                            var __tco___dict_Ord_330 = __dict_Ord_330;
                            var __tco__361 = new Three(_361, (_360[0]).value0, (_360[0]).value1, (_360[0]).value2, (_360[0]).value3, (_360[0]).value4, (_360[0]).value5);
                            __dict_Ord_330 = __tco___dict_Ord_330;
                            _360 = _1173;
                            _361 = __tco__361;
                            continue tco;
                    ...
                    if (_360.length >= 1) {
                        var _1181 = _360.slice(1);
                        if (_360[0] instanceof ThreeMiddle) {
                            var __tco___dict_Ord_330 = __dict_Ord_330;
                            var __tco__361 = new Three((_360[0]).value0, (_360[0]).value1, (_360[0]).value2, _361, (_360[0]).value3, (_360[0]).value4, (_360[0]).value5);
                            __dict_Ord_330 = __tco___dict_Ord_330;
                            _360 = _1181;
                            _361 = __tco__361;
                            continue tco;
                    ...
                    if (_360.length >= 1) {
                        var _1189 = _360.slice(1);
                        if (_360[0] instanceof ThreeRight) {
                            var __tco___dict_Ord_330 = __dict_Ord_330;
                            var __tco__361 = new Three((_360[0]).value0, (_360[0]).value1, (_360[0]).value2, (_360[0]).value3, (_360[0]).value4, (_360[0]).value5, _361);
                            __dict_Ord_330 = __tco___dict_Ord_330;
                            _360 = _1189;
                            _361 = __tco__361;
                            continue tco;
        ...
        var up = function (__copy___dict_Ord_332) {
            return function (__copy__372) {
                return function (__copy__373) {
                    ...
                    tco: while (true) {
                        if (_372.length === 0) {
                            return new Two(_373.value0, _373.value1, _373.value2, _373.value3);
                        };
                        if (_372.length >= 1) {
                            var _1204 = _372.slice(1);
                            if (_372[0] instanceof TwoLeft) {
                                return fromZipper(__dict_Ord_332)(_1204)(new Three(_373.value0, _373.value1, _373.value2, _373.value3, (_372[0]).value0, (_372[0]).value1, (_372[0]).value2));
                            };
                        };
                        if (_372.length >= 1) {
                            var _1213 = _372.slice(1);
                            if (_372[0] instanceof TwoRight) {
                                return fromZipper(__dict_Ord_332)(_1213)(new Three((_372[0]).value0, (_372[0]).value1, (_372[0]).value2, _373.value0, _373.value1, _373.value2, _373.value3));
                            };
                        };
                        if (_372.length >= 1) {
                            var _1225 = _372.slice(1);
                            if (_372[0] instanceof ThreeLeft) {
                                var __tco___dict_Ord_332 = __dict_Ord_332;
                                var __tco__373 = new KickUp(new Two(_373.value0, _373.value1, _373.value2, _373.value3), (_372[0]).value0, (_372[0]).value1, new Two((_372[0]).value2, (_372[0]).value3, (_372[0]).value4, (_372[0]).value5));
                        ...
                        if (_372.length >= 1) {
                            var _1237 = _372.slice(1);
                            if (_372[0] instanceof ThreeMiddle) {
                                var __tco___dict_Ord_332 = __dict_Ord_332;
                                var __tco__373 = new KickUp(new Two((_372[0]).value0, (_372[0]).value1, (_372[0]).value2, _373.value0), _373.value1, _373.value2, new Two(_373.value3, (_372[0]).value3, (_372[0]).value4, (_372[0]).value5));
                                __dict_Ord_332 = __tco___dict_Ord_332;
                                _372 = _1237;
                                _373 = __tco__373;
                                continue tco;
                        ...
                        if (_372.length >= 1) {
                            var _1249 = _372.slice(1);
                            if (_372[0] instanceof ThreeRight) {
                                var __tco___dict_Ord_332 = __dict_Ord_332;
                                var __tco__373 = new KickUp(new Two((_372[0]).value0, (_372[0]).value1, (_372[0]).value2, (_372[0]).value3), (_372[0]).value4, (_372[0]).value5, new Two(_373.value0, _373.value1, _373.value2, _373.value3));
                                __dict_Ord_332 = __tco___dict_Ord_332;
                                _372 = _1249;
                                _373 = __tco__373;
                                continue tco;
                        ...
                        return function (__copy__371) {
                            ...
                            tco: while (true) {
                                if (_371 instanceof Leaf) {
                                    return up(__dict_Ord_333)(_368)(new KickUp(Leaf.value, _369, _370, Leaf.value));
                                };
                                if (_371 instanceof Two && Prelude["=="](__dict_Ord_333["__superclass_Prelude.Eq_0"]())(_369)(_371.value1)) {
                                    return fromZipper(__dict_Ord_333)(_368)(new Two(_371.value0, _369, _370, _371.value3));
                                };
                                if (_371 instanceof Two && Prelude["<"](__dict_Ord_333)(_369)(_371.value1)) {
                                    var __tco___dict_Ord_333 = __dict_Ord_333;
                                    var __tco__368 = Prelude[":"](new TwoLeft(_371.value1, _371.value2, _371.value3))(_368);
                                    var __tco__369 = _369;
                                    var __tco__370 = _370;
                                    var __tco__371 = _371.value0;
                                ...
                                if (_371 instanceof Two) {
                                    var __tco___dict_Ord_333 = __dict_Ord_333;
                                    var __tco__368 = Prelude[":"](new TwoRight(_371.value0, _371.value1, _371.value2))(_368);
                                    var __tco__369 = _369;
                                    var __tco__370 = _370;
                                ...
                                if (_371 instanceof Three && Prelude["=="](__dict_Ord_333["__superclass_Prelude.Eq_0"]())(_369)(_371.value1)) {
                                    return fromZipper(__dict_Ord_333)(_368)(new Three(_371.value0, _369, _370, _371.value3, _371.value4, _371.value5, _371.value6));
                                };
                                if (_371 instanceof Three && Prelude["=="](__dict_Ord_333["__superclass_Prelude.Eq_0"]())(_369)(_371.value4)) {
                                    return fromZipper(__dict_Ord_333)(_368)(new Three(_371.value0, _371.value1, _371.value2, _371.value3, _369, _370, _371.value6));
                                };
                                if (_371 instanceof Three && Prelude["<"](__dict_Ord_333)(_369)(_371.value1)) {
                                    var __tco___dict_Ord_333 = __dict_Ord_333;
                                    var __tco__368 = Prelude[":"](new ThreeLeft(_371.value1, _371.value2, _371.value3, _371.value4, _371.value5, _371.value6))(_368);
                                    var __tco__369 = _369;
                                    var __tco__370 = _370;
                                    var __tco__371 = _371.value0;
                                    __dict_Ord_333 = __tco___dict_Ord_333;
                                ...
                                if (_371 instanceof Three && (Prelude["<"](__dict_Ord_333)(_371.value1)(_369) && Prelude["<="](__dict_Ord_333)(_369)(_371.value4))) {
                                    var __tco___dict_Ord_333 = __dict_Ord_333;
                                    var __tco__368 = Prelude[":"](new ThreeMiddle(_371.value0, _371.value1, _371.value2, _371.value4, _371.value5, _371.value6))(_368);
                                    var __tco__369 = _369;
                                    var __tco__370 = _370;
                                    var __tco__371 = _371.value3;
                                    __dict_Ord_333 = __tco___dict_Ord_333;
                                ...
                                if (_371 instanceof Three) {
                                    var __tco___dict_Ord_333 = __dict_Ord_333;
                                    var __tco__368 = Prelude[":"](new ThreeRight(_371.value0, _371.value1, _371.value2, _371.value3, _371.value4, _371.value5))(_368);
                                    var __tco__369 = _369;
                                    var __tco__370 = _370;
            ...
            return function (m2) {
                return Data_Foldable.foldl(Data_Foldable.foldableArray())(function (m) {
                    return function (_355) {
                        return insert(__dict_Ord_334)(_355.value0)(_355.value1)(m);
                    };
                })(m2)(toList(m1));
            };
        };
    ...
    var fromList = function (__dict_Ord_337) {
        return Data_Foldable.foldl(Data_Foldable.foldableArray())(function (m) {
            return function (_354) {
                return insert(__dict_Ord_337)(_354.value0)(_354.value1)(m);
            };
        })(empty);
    };
    ...
    var $$delete = function (__dict_Ord_339) {
            ...
            return function (__copy__377) {
                return function (__copy__378) {
                    ...
                    tco: while (true) {
                        ...
                        if (_377.length >= 1) {
                            var _1313 = _377.slice(1);
                            if (_377[0] instanceof TwoLeft && ((_377[0]).value2 instanceof Leaf && _378 instanceof Leaf)) {
                                return fromZipper(__dict_Ord_340)(_1313)(new Two(Leaf.value, (_377[0]).value0, (_377[0]).value1, Leaf.value));
                            };
                        };
                        if (_377.length >= 1) {
                            var _1318 = _377.slice(1);
                            if (_377[0] instanceof TwoRight && ((_377[0]).value0 instanceof Leaf && _378 instanceof Leaf)) {
                                return fromZipper(__dict_Ord_340)(_1318)(new Two(Leaf.value, (_377[0]).value1, (_377[0]).value2, Leaf.value));
                            };
                        };
                        if (_377.length >= 1) {
                            var _1327 = _377.slice(1);
                            if (_377[0] instanceof TwoLeft && (_377[0]).value2 instanceof Two) {
                                var __tco___dict_Ord_340 = __dict_Ord_340;
                                var __tco__378 = new Three(_378, (_377[0]).value0, (_377[0]).value1, (_377[0]).value2.value0, (_377[0]).value2.value1, (_377[0]).value2.value2, (_377[0]).value2.value3);
                        ...
                        if (_377.length >= 1) {
                            var _1336 = _377.slice(1);
                            if (_377[0] instanceof TwoRight && (_377[0]).value0 instanceof Two) {
                                var __tco___dict_Ord_340 = __dict_Ord_340;
                                var __tco__378 = new Three((_377[0]).value0.value0, (_377[0]).value0.value1, (_377[0]).value0.value2, (_377[0]).value0.value3, (_377[0]).value1, (_377[0]).value2, _378);
                                __dict_Ord_340 = __tco___dict_Ord_340;
                                _377 = _1336;
                                _378 = __tco__378;
                                continue tco;
                        ...
                        if (_377.length >= 1) {
                            var _1348 = _377.slice(1);
                            if (_377[0] instanceof TwoLeft && (_377[0]).value2 instanceof Three) {
                                return fromZipper(__dict_Ord_340)(_1348)(new Two(new Two(_378, (_377[0]).value0, (_377[0]).value1, (_377[0]).value2.value0), (_377[0]).value2.value1, (_377[0]).value2.value2, new Two((_377[0]).value2.value3, (_377[0]).value2.value4, (_377[0]).value2.value5, (_377[0]).value2.value6)));
                            };
                        };
                        if (_377.length >= 1) {
                            var _1360 = _377.slice(1);
                            if (_377[0] instanceof TwoRight && (_377[0]).value0 instanceof Three) {
                                return fromZipper(__dict_Ord_340)(_1360)(new Two(new Two((_377[0]).value0.value0, (_377[0]).value0.value1, (_377[0]).value0.value2, (_377[0]).value0.value3), (_377[0]).value0.value4, (_377[0]).value0.value5, new Two((_377[0]).value0.value6, (_377[0]).value1, (_377[0]).value2, _378)));
                            };
                        };
                        if (_377.length >= 1) {
                            var _1368 = _377.slice(1);
                            if (_377[0] instanceof ThreeLeft && ((_377[0]).value2 instanceof Leaf && ((_377[0]).value5 instanceof Leaf && _378 instanceof Leaf))) {
                                return fromZipper(__dict_Ord_340)(_1368)(new Three(Leaf.value, (_377[0]).value0, (_377[0]).value1, Leaf.value, (_377[0]).value3, (_377[0]).value4, Leaf.value));
                            };
                        };
                        if (_377.length >= 1) {
                            var _1376 = _377.slice(1);
                            if (_377[0] instanceof ThreeMiddle && ((_377[0]).value0 instanceof Leaf && ((_377[0]).value5 instanceof Leaf && _378 instanceof Leaf))) {
                                return fromZipper(__dict_Ord_340)(_1376)(new Three(Leaf.value, (_377[0]).value1, (_377[0]).value2, Leaf.value, (_377[0]).value3, (_377[0]).value4, Leaf.value));
                            };
                        };
                        if (_377.length >= 1) {
                            var _1384 = _377.slice(1);
                            if (_377[0] instanceof ThreeRight && ((_377[0]).value0 instanceof Leaf && ((_377[0]).value3 instanceof Leaf && _378 instanceof Leaf))) {
                                return fromZipper(__dict_Ord_340)(_1384)(new Three(Leaf.value, (_377[0]).value1, (_377[0]).value2, Leaf.value, (_377[0]).value4, (_377[0]).value5, Leaf.value));
                            };
                        };
                        if (_377.length >= 1) {
                            var _1396 = _377.slice(1);
                            if (_377[0] instanceof ThreeLeft && (_377[0]).value2 instanceof Two) {
                                return fromZipper(__dict_Ord_340)(_1396)(new Two(new Three(_378, (_377[0]).value0, (_377[0]).value1, (_377[0]).value2.value0, (_377[0]).value2.value1, (_377[0]).value2.value2, (_377[0]).value2.value3), (_377[0]).value3, (_377[0]).value4, (_377[0]).value5));
                            };
                        };
                        if (_377.length >= 1) {
                            var _1408 = _377.slice(1);
                            if (_377[0] instanceof ThreeMiddle && (_377[0]).value0 instanceof Two) {
                                return fromZipper(__dict_Ord_340)(_1408)(new Two(new Three((_377[0]).value0.value0, (_377[0]).value0.value1, (_377[0]).value0.value2, (_377[0]).value0.value3, (_377[0]).value1, (_377[0]).value2, _378), (_377[0]).value3, (_377[0]).value4, (_377[0]).value5));
                            };
                        };
                        if (_377.length >= 1) {
                            var _1420 = _377.slice(1);
                            if (_377[0] instanceof ThreeMiddle && (_377[0]).value5 instanceof Two) {
                                return fromZipper(__dict_Ord_340)(_1420)(new Two((_377[0]).value0, (_377[0]).value1, (_377[0]).value2, new Three(_378, (_377[0]).value3, (_377[0]).value4, (_377[0]).value5.value0, (_377[0]).value5.value1, (_377[0]).value5.value2, (_377[0]).value5.value3)));
                            };
                        };
                        if (_377.length >= 1) {
                            var _1432 = _377.slice(1);
                            if (_377[0] instanceof ThreeRight && (_377[0]).value3 instanceof Two) {
                                return fromZipper(__dict_Ord_340)(_1432)(new Two((_377[0]).value0, (_377[0]).value1, (_377[0]).value2, new Three((_377[0]).value3.value0, (_377[0]).value3.value1, (_377[0]).value3.value2, (_377[0]).value3.value3, (_377[0]).value4, (_377[0]).value5, _378)));
                            };
                        };
                        if (_377.length >= 1) {
                            var _1447 = _377.slice(1);
                            if (_377[0] instanceof ThreeLeft && (_377[0]).value2 instanceof Three) {
                                return fromZipper(__dict_Ord_340)(_1447)(new Three(new Two(_378, (_377[0]).value0, (_377[0]).value1, (_377[0]).value2.value0), (_377[0]).value2.value1, (_377[0]).value2.value2, new Two((_377[0]).value2.value3, (_377[0]).value2.value4, (_377[0]).value2.value5, (_377[0]).value2.value6), (_377[0]).value3, (_377[0]).value4, (_377[0]).value5));
                            };
                        };
                        if (_377.length >= 1) {
                            var _1462 = _377.slice(1);
                            if (_377[0] instanceof ThreeMiddle && (_377[0]).value0 instanceof Three) {
                                return fromZipper(__dict_Ord_340)(_1462)(new Three(new Two((_377[0]).value0.value0, (_377[0]).value0.value1, (_377[0]).value0.value2, (_377[0]).value0.value3), (_377[0]).value0.value4, (_377[0]).value0.value5, new Two((_377[0]).value0.value6, (_377[0]).value1, (_377[0]).value2, _378), (_377[0]).value3, (_377[0]).value4, (_377[0]).value5));
                            };
                        };
                        if (_377.length >= 1) {
                            var _1477 = _377.slice(1);
                            if (_377[0] instanceof ThreeMiddle && (_377[0]).value5 instanceof Three) {
                                return fromZipper(__dict_Ord_340)(_1477)(new Three((_377[0]).value0, (_377[0]).value1, (_377[0]).value2, new Two(_378, (_377[0]).value3, (_377[0]).value4, (_377[0]).value5.value0), (_377[0]).value5.value1, (_377[0]).value5.value2, new Two((_377[0]).value5.value3, (_377[0]).value5.value4, (_377[0]).value5.value5, (_377[0]).value5.value6)));
                            };
                        };
                        if (_377.length >= 1) {
                            var _1492 = _377.slice(1);
                            if (_377[0] instanceof ThreeRight && (_377[0]).value3 instanceof Three) {
                                return fromZipper(__dict_Ord_340)(_1492)(new Three((_377[0]).value0, (_377[0]).value1, (_377[0]).value2, new Two((_377[0]).value3.value0, (_377[0]).value3.value1, (_377[0]).value3.value2, (_377[0]).value3.value3), (_377[0]).value3.value4, (_377[0]).value3.value5, new Two((_377[0]).value3.value6, (_377[0]).value4, (_377[0]).value5, _378)));
                            };
                        };
                        throw new Error("Failed pattern match");
                    };
        ...
        var removeMaxNode = function (__copy___dict_Ord_341) {
            return function (__copy__380) {
                return function (__copy__381) {
                    ...
                    tco: while (true) {
                        if (_381 instanceof Two && (_381.value0 instanceof Leaf && _381.value3 instanceof Leaf)) {
                            return up(__dict_Ord_341)(_380)(Leaf.value);
                        };
                        if (_381 instanceof Two) {
                            var __tco___dict_Ord_341 = __dict_Ord_341;
                            var __tco__380 = Prelude[":"](new TwoRight(_381.value0, _381.value1, _381.value2))(_380);
                            var __tco__381 = _381.value3;
                            __dict_Ord_341 = __tco___dict_Ord_341;
                            _380 = __tco__380;
                            _381 = __tco__381;
                            continue tco;
                        };
                        if (_381 instanceof Three && (_381.value0 instanceof Leaf && (_381.value3 instanceof Leaf && _381.value6 instanceof Leaf))) {
                            return up(__dict_Ord_341)(Prelude[":"](new TwoRight(Leaf.value, _381.value1, _381.value2))(_380))(Leaf.value);
                        };
                        if (_381 instanceof Three) {
                            var __tco___dict_Ord_341 = __dict_Ord_341;
                            var __tco__380 = Prelude[":"](new ThreeRight(_381.value0, _381.value1, _381.value2, _381.value3, _381.value4, _381.value5))(_380);
                            var __tco__381 = _381.value6;
                            __dict_Ord_341 = __tco___dict_Ord_341;
                            _380 = __tco__380;
                            _381 = __tco__381;
                            continue tco;
        ...
        var maxNode = function (__copy___dict_Ord_342) {
            return function (__copy__379) {
                ...
                tco: while (true) {
                    if (_379 instanceof Two && _379.value3 instanceof Leaf) {
                        return {
                            key: _379.value1, 
                            value: _379.value2
                        };
                    ...
                    if (_379 instanceof Three && _379.value6 instanceof Leaf) {
                        return {
                            key: _379.value4, 
                            value: _379.value5
                        };
                    ...
                    return function (__copy__376) {
                        ...
                        tco: while (true) {
                            if (_376 instanceof Leaf) {
                                return fromZipper(__dict_Ord_343)(_374)(Leaf.value);
                            };
                            if (_376 instanceof Two && (_376.value0 instanceof Leaf && (_376.value3 instanceof Leaf && Prelude["=="](__dict_Ord_343["__superclass_Prelude.Eq_0"]())(_375)(_376.value1)))) {
                                return up(__dict_Ord_343)(_374)(Leaf.value);
                            };
                            if (_376 instanceof Two && Prelude["=="](__dict_Ord_343["__superclass_Prelude.Eq_0"]())(_375)(_376.value1)) {
                                var max = maxNode(__dict_Ord_343)(_376.value0);
                                return removeMaxNode(__dict_Ord_343)(Prelude[":"](new TwoLeft(max.key, max.value, _376.value3))(_374))(_376.value0);
                            };
                            if (_376 instanceof Two && Prelude["<"](__dict_Ord_343)(_375)(_376.value1)) {
                                var __tco___dict_Ord_343 = __dict_Ord_343;
                                var __tco__374 = Prelude[":"](new TwoLeft(_376.value1, _376.value2, _376.value3))(_374);
                                var __tco__375 = _375;
                            ...
                            if (_376 instanceof Two) {
                                var __tco___dict_Ord_343 = __dict_Ord_343;
                                var __tco__374 = Prelude[":"](new TwoRight(_376.value0, _376.value1, _376.value2))(_374);
                                var __tco__375 = _375;
                            ...
                            if (_376 instanceof Three && (_376.value0 instanceof Leaf && (_376.value3 instanceof Leaf && (_376.value6 instanceof Leaf && Prelude["=="](__dict_Ord_343["__superclass_Prelude.Eq_0"]())(_375)(_376.value1))))) {
                                return fromZipper(__dict_Ord_343)(_374)(new Two(Leaf.value, _376.value4, _376.value5, Leaf.value));
                            };
                            if (_376 instanceof Three && (_376.value0 instanceof Leaf && (_376.value3 instanceof Leaf && (_376.value6 instanceof Leaf && Prelude["=="](__dict_Ord_343["__superclass_Prelude.Eq_0"]())(_375)(_376.value4))))) {
                                return fromZipper(__dict_Ord_343)(_374)(new Two(Leaf.value, _376.value1, _376.value2, Leaf.value));
                            };
                            if (_376 instanceof Three && Prelude["=="](__dict_Ord_343["__superclass_Prelude.Eq_0"]())(_375)(_376.value1)) {
                                var max = maxNode(__dict_Ord_343)(_376.value0);
                                return removeMaxNode(__dict_Ord_343)(Prelude[":"](new ThreeLeft(max.key, max.value, _376.value3, _376.value4, _376.value5, _376.value6))(_374))(_376.value0);
                            };
                            if (_376 instanceof Three && Prelude["=="](__dict_Ord_343["__superclass_Prelude.Eq_0"]())(_375)(_376.value4)) {
                                var max = maxNode(__dict_Ord_343)(_376.value3);
                                return removeMaxNode(__dict_Ord_343)(Prelude[":"](new ThreeMiddle(_376.value0, _376.value1, _376.value2, max.key, max.value, _376.value6))(_374))(_376.value3);
                            };
                            if (_376 instanceof Three && Prelude["<"](__dict_Ord_343)(_375)(_376.value1)) {
                                var __tco___dict_Ord_343 = __dict_Ord_343;
                                var __tco__374 = Prelude[":"](new ThreeLeft(_376.value1, _376.value2, _376.value3, _376.value4, _376.value5, _376.value6))(_374);
                                var __tco__375 = _375;
                                var __tco__376 = _376.value0;
                                __dict_Ord_343 = __tco___dict_Ord_343;
                                _374 = __tco__374;
                            ...
                            if (_376 instanceof Three && (Prelude["<"](__dict_Ord_343)(_376.value1)(_375) && Prelude["<"](__dict_Ord_343)(_375)(_376.value4))) {
                                var __tco___dict_Ord_343 = __dict_Ord_343;
                                var __tco__374 = Prelude[":"](new ThreeMiddle(_376.value0, _376.value1, _376.value2, _376.value4, _376.value5, _376.value6))(_374);
                                var __tco__375 = _375;
                                var __tco__376 = _376.value3;
                                __dict_Ord_343 = __tco___dict_Ord_343;
                                _374 = __tco__374;
                            ...
                            if (_376 instanceof Three) {
                                var __tco___dict_Ord_343 = __dict_Ord_343;
                                var __tco__374 = Prelude[":"](new ThreeRight(_376.value0, _376.value1, _376.value2, _376.value3, _376.value4, _376.value5))(_374);
                                var __tco__375 = _375;
        ...
        var allHeights = function (_367) {
            ...
            if (_367 instanceof Two) {
                return Data_Array.map(function (n) {
                    return n + 1;
                })(Prelude["++"](Data_Array.semigroupArray())(allHeights(_367.value0))(allHeights(_367.value3)));
            };
            if (_367 instanceof Three) {
                return Data_Array.map(function (n) {
                    return n + 1;
                })(Prelude["++"](Data_Array.semigroupArray())(allHeights(_367.value0))(Prelude["++"](Data_Array.semigroupArray())(allHeights(_367.value3))(allHeights(_367.value6))));
            };
            throw new Error("Failed pattern match");
        };
    ...
    var alter = function (__dict_Ord_344) {
        return function (f) {
            return function (k) {
                return function (m) {
                    var _1620 = f(lookup(__dict_Ord_344)(k)(m));
                    if (_1620 instanceof Data_Maybe.Nothing) {
                        return $$delete(__dict_Ord_344)(k)(m);
                    };
                    if (_1620 instanceof Data_Maybe.Just) {
                        return insert(__dict_Ord_344)(k)(_1620.value0)(m);
                    };
                    throw new Error("Failed pattern match");
                };
            };
...
PS.Data_Monoid_Last = (function () {
    ...
    var showLast = function (__dict_Show_346) {
        return new Prelude.Show(function (_389) {
            return "Last (" + (Prelude.show(Data_Maybe.showMaybe(__dict_Show_346))(_389) + ")");
        });
    };
    var semigroupLast = function () {
        return new Prelude.Semigroup(function (_390) {
    ...
    var eqLast = function (__dict_Eq_348) {
        return new Prelude.Eq(function (_385) {
            return function (_386) {
                return Prelude["/="](Data_Maybe.eqMaybe(__dict_Eq_348))(_385)(_386);
            };
        }, function (_383) {
            return function (_384) {
                return Prelude["=="](Data_Maybe.eqMaybe(__dict_Eq_348))(_383)(_384);
            };
        });
    };
    var ordLast = function (__dict_Ord_347) {
        return new Prelude.Ord(function () {
            ...
            return function (_388) {
                return Prelude.compare(Data_Maybe.ordMaybe(__dict_Ord_347))(_387)(_388);
            };
        });
    };
    return {
    ...
    var union = function (__dict_Ord_349) {
        return function (_401) {
            return function (_402) {
                return new Set(Data_Map.union(__dict_Ord_349)(_401.value0)(_402.value0));
            };
        };
    };
    var toList = function (_400) {
        return Data_Array.map(Data_Tuple.fst)(Data_Map.toList(_400.value0));
    };
    var singleton = function (a) {
    ...
    var member = function (__dict_Ord_351) {
        return function (_394) {
            return function (_395) {
                return Data_Map.member(__dict_Ord_351)(_394)(_395.value0);
            };
        };
    };
    var isEmpty = function (_392) {
        return Data_Map.isEmpty(_392.value0);
    };
    var insert = function (__dict_Ord_352) {
        return function (_396) {
            return function (_397) {
                return new Set(Data_Map.insert(__dict_Ord_352)(_396)(Prelude.unit)(_397.value0));
            };
        };
    };
    var eqSet = function (__dict_Eq_353) {
        return new Prelude.Eq(function (_405) {
            return function (_406) {
                return Prelude["/="](Data_Map.eqMap(__dict_Eq_353)(Prelude.eqUnit()))(_405.value0)(_406.value0);
            };
        }, function (_403) {
            return function (_404) {
                return Prelude["=="](Data_Map.eqMap(__dict_Eq_353)(Prelude.eqUnit()))(_403.value0)(_404.value0);
            };
        });
    };
    ...
    var $$delete = function (__dict_Ord_356) {
        return function (_398) {
            return function (_399) {
                return new Set(Data_Map["delete"](__dict_Ord_356)(_398)(_399.value0));
            };
        };
    };
    var checkValid = function (_393) {
        return Data_Map.checkValid(_393.value0);
    };
    return {
        unions: unions, 
        union: union, 
...
PS.Data_StrMap = (function () {
    ...
    var fromList = Data_Foldable.foldl(Data_Foldable.foldableArray())(function (m) {
        return function (_407) {
            return insert(_407.value0)(_407.value1)(m);
        };
    })(empty);
    ...
    var traversableTuple = function () {
        return new Traversable(Data_Foldable.foldableTuple, Data_Tuple.functorTuple, function (__dict_Applicative_361) {
            return function (_423) {
                return Prelude["<$>"]((__dict_Applicative_361["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Data_Tuple.Tuple.create(_423.value0))(_423.value1);
            };
        }, function (__dict_Applicative_360) {
            return function (_421) {
                return function (_422) {
                    return Prelude["<$>"]((__dict_Applicative_360["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Data_Tuple.Tuple.create(_422.value0))(_421(_422.value1));
                };
            };
        });
    };
    var traversableRef = function () {
        return new Traversable(Data_Foldable.foldableRef, Data_Eq.functorRef, function (__dict_Applicative_363) {
            return function (_417) {
                return Prelude["<$>"]((__dict_Applicative_363["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Data_Eq.Ref.create)(_417);
            };
        }, function (__dict_Applicative_362) {
            return function (_415) {
                return function (_416) {
                    return Prelude["<$>"]((__dict_Applicative_362["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Data_Eq.Ref.create)(_415(_416));
                };
            };
        });
    };
        ...
        return new Traversable(Data_Foldable.foldableMaybe, Data_Maybe.functorMaybe, function (__dict_Applicative_365) {
            return function (_420) {
                ...
                if (_420 instanceof Data_Maybe.Just) {
                    return Prelude["<$>"]((__dict_Applicative_365["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Data_Maybe.Just.create)(_420.value0);
                };
                throw new Error("Failed pattern match");
            };
            ...
            return function (_418) {
                return function (_419) {
                    ...
                    if (_419 instanceof Data_Maybe.Just) {
                        return Prelude["<$>"]((__dict_Applicative_364["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Data_Maybe.Just.create)(_418(_419.value0));
                    };
                    throw new Error("Failed pattern match");
                };
            };
        ...
        return new Traversable(Data_Foldable.foldableEither, Data_Either.functorEither, function (__dict_Applicative_367) {
            return function (_414) {
                if (_414 instanceof Data_Either.Left) {
                    return Prelude.pure(__dict_Applicative_367)(new Data_Either.Left(_414.value0));
                };
                if (_414 instanceof Data_Either.Right) {
                    return Prelude["<$>"]((__dict_Applicative_367["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Data_Either.Right.create)(_414.value0);
                };
                throw new Error("Failed pattern match");
            };
            ...
            return function (_412) {
                return function (_413) {
                    if (_413 instanceof Data_Either.Left) {
                        return Prelude.pure(__dict_Applicative_366)(new Data_Either.Left(_413.value0));
                    };
                    if (_413 instanceof Data_Either.Right) {
                        return Prelude["<$>"]((__dict_Applicative_366["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Data_Either.Right.create)(_412(_413.value0));
                    };
                    throw new Error("Failed pattern match");
                };
            };
    ...
    var traversableArray = function () {
        return new Traversable(Data_Foldable.foldableArray, Data_Array.functorArray, function (__dict_Applicative_369) {
            return function (_411) {
                ...
                if (_411.length >= 1) {
                    var _1692 = _411.slice(1);
                    return Prelude["<*>"](__dict_Applicative_369["__superclass_Prelude.Apply_0"]())(Prelude["<$>"]((__dict_Applicative_369["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Prelude[":"])(_411[0]))(sequence(traversableArray())(__dict_Applicative_369)(_1692));
                };
                throw new Error("Failed pattern match");
            };
            ...
            return function (_409) {
                return function (_410) {
                    ...
                    if (_410.length >= 1) {
                        var _1696 = _410.slice(1);
                        return Prelude["<*>"](__dict_Applicative_368["__superclass_Prelude.Apply_0"]())(Prelude["<$>"]((__dict_Applicative_368["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Prelude[":"])(_409(_410[0])))(traverse(traversableArray())(__dict_Applicative_368)(_409)(_1696));
                    };
                    throw new Error("Failed pattern match");
                };
            };
...
PS.Data_Graph = (function () {
    ...
    var showSCC = function (__dict_Show_381) {
        return new Prelude.Show(function (_436) {
            if (_436 instanceof AcyclicSCC) {
                return "AcyclicSCC (" + (Prelude.show(__dict_Show_381)(_436.value0) + ")");
            };
            if (_436 instanceof CyclicSCC) {
                return "CyclicSCC " + Prelude.show(Prelude.showArray(__dict_Show_381))(_436.value0);
            };
            throw new Error("Failed pattern match");
        });
    };
                ...
                return function (__copy__432) {
                    return function (__copy__433) {
                        ...
                        tco: while (true) {
                            ...
                            if (_432.length >= 1) {
                                var _1708 = _432.slice(1);
                                if (Prelude["=="](__dict_Eq_382)(_430(_431))(_430(_432[0]))) {
                                    return {
                                        path: _1708, 
                                        component: Prelude[":"](_432[0])(_433)
                                    };
                                };
                            };
                            if (_432.length >= 1) {
                                var _1710 = _432.slice(1);
                                var __tco___dict_Eq_382 = __dict_Eq_382;
                                var __tco__430 = _430;
                                var __tco__431 = _431;
                                var __tco__433 = Prelude[":"](_432[0])(_433);
    ...
    var maybeMin = function (_434) {
        return function (_435) {
            if (_435 instanceof Data_Maybe.Nothing) {
                return new Data_Maybe.Just(_434);
            };
            if (_435 instanceof Data_Maybe.Just) {
                return Data_Maybe.Just.create(Math.min(_434)(_435.value0));
            };
            throw new Error("Failed pattern match");
        };
    };
                        ...
                        return Control_Monad_Eff.runPure(function __do() {
                            ...
                            return (function () {
                                ...
                                var lowlinkOf = function (v) {
                                    return lowlinkOfKey(_427(v));
                                };
                                var isCycle = function (k) {
                                    return Data_Foldable.any(Data_Foldable.foldableArray())(function (_425) {
                                        return Prelude["=="](__dict_Eq_383)(_425.value0)(k) && Prelude["=="](__dict_Eq_383)(_425.value1)(k);
                                    })(_429.value1);
                                };
                                var makeComponent = function (_440) {
                                    if (_440.length === 1 && !isCycle(_427(_440[0]))) {
                                        return new AcyclicSCC(_440[0]);
                                    };
                                    return new CyclicSCC(_440);
                                };
                                ...
                                var strongConnect = function (k) {
                                    ...
                                    return function __do() {
                                        ...
                                        Data_Traversable["for"](Control_Monad_Eff.applicativeEff())(Data_Traversable.traversableArray())(_429.value1)(function (_424) {
                                            return Control_Monad.when(Control_Monad_Eff.monadEff())(Prelude["=="](__dict_Eq_383)(k)(_424.value0))(function __do() {
                                                var _49 = indexOfKey(_424.value1)();
                                                return (function () {
                                                    if (_49 instanceof Data_Maybe.Nothing) {
                                                        var w = _428(_424.value1);
                                                        return function __do() {
                                                            strongConnect(_424.value1)();
                                                            var _46 = lowlinkOfKey(_424.value1)();
                                                    ...
                                                    return Control_Monad.when(Control_Monad_Eff.monadEff())(Data_Foldable.elem(__dict_Eq_383)(Data_Foldable.foldableArray())(_424.value1)(Data_Array.map(_427)(_57.value)))(function __do() {
                                                        var _47 = indexOfKey(_424.value1)();
                                        ...
                                        return Control_Monad.when(Control_Monad_Eff.monadEff())(Prelude["=="](Data_Maybe.eqMaybe(Prelude.eqNumber()))(_52)(_51))(function __do() {
                                            var _50 = _57.value;
                                            return (function () {
                                                var newPath = popUntil(__dict_Eq_383)(_427)(v)(_50)([  ]);
                                                return function __do() {
                                ...
                                var go = function (_439) {
                                    ...
                                    if (_439.length >= 1) {
                                        var _1744 = _439.slice(1);
                                        return function __do() {
                                            var _45 = indexOf(_439[0])();
                                            Control_Monad.when(Control_Monad_Eff.monadEff())(Data_Maybe.isNothing(_45))(strongConnect(_427(_439[0])))();
                                            return go(_1744)();
                                        };
                                    };
                                    throw new Error("Failed pattern match");
                                };
                                return go(_429.value0);
                            })()();
                        });
                    };
                };
    ...
    var eqSCC = function (__dict_Eq_391) {
        return new Prelude.Eq(function (scc1) {
            ...
            return function (_438) {
                if (_437 instanceof AcyclicSCC && _438 instanceof AcyclicSCC) {
                    return Prelude["=="](__dict_Eq_391)(_437.value0)(_438.value0);
                };
                if (_437 instanceof CyclicSCC && _438 instanceof CyclicSCC) {
                    return Prelude["=="](Prelude.eqArray(__dict_Eq_391))(_437.value0)(_438.value0);
                };
                return false;
            };
        });
...
PS.Presentable_Router = (function () {
    ...
    var defaultRoute = function (rs) {
        var _1753 = Data_Array.head(rs);
        if (_1753 instanceof Data_Maybe.Nothing) {
            return Control_Monad_Eff_Exception.throwException(Control_Monad_Eff_Exception.error("Your Routes are empty"));
        };
        if (_1753 instanceof Data_Maybe.Just) {
            return Prelude["return"](Control_Monad_Eff.monadEff())(Data_Tuple.fst(_1753.value0));
        };
        throw new Error("Failed pattern match");
    };
        ...
        return function (f) {
            return History.subscribeStateChange(function (e) {
                return Prelude[">>="](Control_Monad_Eff.bindEff())(defaultRoute(rs))(function (d) {
                    var _1755 = Data_Array.filter(function (x) {
                    ...
                    if (_1755.length >= 1) {
                        var _1757 = _1755.slice(1);
                        return f(Data_Tuple.snd(_1755[0]));
                    };
                    throw new Error("Failed pattern match");
                });
            });
...
PS.Presentable_ViewParser = (function () {
    ...
    var render = function (ns) {
        var r = function (_443) {
            return function (_444) {
                if (_444.value2 instanceof Data_Maybe.Nothing) {
                    return _444.value0(_443)(_444.value1);
                };
                if (_444.value2 instanceof Data_Maybe.Just) {
                    return function __do() {
                        var _59 = r(_443)(new Presentable.Presentable(_444.value0, _444.value1, Data_Maybe.Nothing.value))();
                        Data_Traversable.traverse(Data_Traversable.traversableArray())(Control_Monad_Eff.applicativeEff())(r(_59))(_444.value2.value0)();
                        return _59;
                    };
                };
                throw new Error("Failed pattern match");
        ...
        return Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff())(Data_Foldable.foldableArray())(r(Data_Maybe.Nothing.value))(ns);
    };
    ...
    var makePresentable = function (r) {
        return function (node) {
            ...
            var handleC = function (_441) {
                return function (_442) {
                    if (_442 instanceof Data_Maybe.Nothing) {
                        return Prelude["return"](Control_Monad_Eff.monadEff())(returnP(_441)(Data_Maybe.Nothing.value));
                    };
                    if (_442 instanceof Data_Maybe.Just) {
                        return Prelude[">>="](Control_Monad_Eff.bindEff())(Data_Traversable.traverse(Data_Traversable.traversableArray())(Control_Monad_Eff.applicativeEff())(makePresentable(r))(_442.value0))(Prelude[">>>"](Prelude.semigroupoidArr())(Data_Maybe.Just.create)(Prelude[">>>"](Prelude.semigroupoidArr())(returnP(_441))(Prelude["return"](Control_Monad_Eff.monadEff()))));
                    };
                    throw new Error("Failed pattern match");
                };
            };
            var _1771 = Data_Map.lookup(Prelude.ordString())(name)(r);
            if (_1771 instanceof Data_Maybe.Nothing) {
                return $$throw(name + " not found in registry");
            };
            if (_1771 instanceof Data_Maybe.Just) {
                return handleC(_1771.value0)(getChildren(node));
            };
            throw new Error("Failed pattern match");
        };
    };
    ...
    var renderYaml = function (yaml) {
        return function (r) {
            var yamlToForeign = Data_Function.runFn3(parseYaml)(Data_Either.Left.create)(Data_Either.Right.create);
            var _1776 = yamlToForeign(yaml);
            if (_1776 instanceof Data_Either.Right) {
                return Prelude[">>="](Control_Monad_Eff.bindEff())(parse(_1776.value0)(r))(render);
            };
            if (_1776 instanceof Data_Either.Left) {
                return $$throw("Yaml view failed to parse : " + _1776.value0);
            };
            throw new Error("Failed pattern match");
        };
    };
...
PS.Test_QuickCheck_LCG = (function () {
        ...
        var f = function (s) {
            return {
                ...
                state: (function () {
                    ...
                    _1785.newSeed = lcgNext(s.newSeed);
                    return _1785;
                })()
            };
        };
    ...
    var perturbGen = function (_446) {
        return function (_447) {
            return Gen.create(function (s) {
                return _447.value0((function () {
                    var _1789 = {};
                    for (var _1790 in s) {
                        if (s.hasOwnProperty(_1790)) {
                            _1789[_1790] = s[_1790];
                        };
                    };
                    _1789.newSeed = lcgNext(float32ToInt32(_446)) + s.newSeed;
                    return _1789;
                })());
            });
        };
    ...
    var functorGen = function () {
        return new Prelude.Functor(function (_451) {
            return function (_452) {
                return Gen.create(function (s) {
                    var _1794 = _452.value0(s);
                    return {
                        value: _451(_1794.value), 
                        state: _1794.state
                    };
                });
            };
    ...
    var applyGen = function () {
        return new Prelude.Apply(function (_453) {
            return function (_454) {
                return Gen.create(function (s) {
                    var _1800 = _453.value0(s);
                    var _1801 = _454.value0(_1800.state);
                    return {
                        value: _1800.value(_1801.value), 
                        state: _1801.state
                    };
                });
            };
    ...
    var bindGen = function () {
        return new Prelude.Bind(function (_455) {
            return function (_456) {
                return Gen.create(function (s) {
                    var _1810 = _455.value0(s);
                    return runGen(_456(_1810.value))(_1810.state);
                });
            };
        }, applyGen);
    };
            ...
            var pick = function (_448) {
                return function (_449) {
                    return function (_450) {
                        ...
                        if (_450.length >= 1) {
                            var _1820 = _450.slice(1);
                            return _448 <= (_450[0]).value0 ? (_450[0]).value1 : pick(_448 - (_450[0]).value0)(_449)(_1820);
                        };
                        throw new Error("Failed pattern match");
                    };
                };
...
PS.Test_QuickCheck = (function () {
    ...
    var $less$qmark$greater = function (_457) {
        return function (_458) {
            if (_457) {
                return Success.value;
            };
            if (!_457) {
                return new Failed(_458);
            };
            throw new Error("Failed pattern match");
        };
    };
    ...
    var testableBoolean = function () {
        return new Testable(function (_466) {
            if (_466) {
    ...
    var showResult = function () {
        return new Prelude.Show(function (_459) {
            if (_459 instanceof Success) {
                return "Success";
            };
            if (_459 instanceof Failed) {
                return "Failed: " + _459.value0;
            };
            throw new Error("Failed pattern match");
        });
    };
                    ...
                    return function (prop) {
                        var go = function (_467) {
                            ...
                            return Prelude[">>="](Test_QuickCheck_LCG.bindGen())(test(__dict_Testable_394)(prop))(function (_78) {
                                return Prelude[">>="](Test_QuickCheck_LCG.bindGen())(go(_467 - 1))(function (_77) {
    ...
    var quickCheck$prime = function (__dict_Testable_395) {
        return function (n) {
            return function (prop) {
                var throwOnFirstFailure = function (__copy__468) {
                    return function (__copy__469) {
                        ...
                        tco: while (true) {
                            ...
                            if (_469.length >= 1) {
                                var _1840 = _469.slice(1);
                                if (_469[0] instanceof Failed) {
                                    return Control_Monad_Eff_Exception.throwException(Control_Monad_Eff_Exception.error("Test " + (Prelude.show(Prelude.showNumber())(_468) + (" failed: \n" + (_469[0]).value0))));
                                };
                            };
                            if (_469.length >= 1) {
                                var _1842 = _469.slice(1);
                                var __tco__468 = _468 + 1;
                                _468 = __tco__468;
                                _469 = _1842;
                                continue tco;
                            };
                ...
                var countSuccesses = function (_470) {
                    if (_470.length === 0) {
                        return 0;
                    };
                    if (_470.length >= 1) {
                        var _1845 = _470.slice(1);
                        if (_470[0] instanceof Success) {
                            return 1 + countSuccesses(_1845);
                        };
                    };
                    if (_470.length >= 1) {
                        var _1847 = _470.slice(1);
                        return countSuccesses(_1847);
                    };
                    throw new Error("Failed pattern match");
                };
                return function __do() {
    ...
    var coarbTuple = function (__dict_CoArbitrary_397) {
        return function (__dict_CoArbitrary_398) {
            return new CoArbitrary(function (_462) {
                return Prelude[">>>"](Prelude.semigroupoidArr())(coarbitrary(__dict_CoArbitrary_397)(_462.value0))(coarbitrary(__dict_CoArbitrary_398)(_462.value1));
            });
        };
    };
    ...
    var coarbMaybe = function (__dict_CoArbitrary_399) {
        return new CoArbitrary(function (_464) {
            ...
            if (_464 instanceof Data_Maybe.Just) {
                return coarbitrary(__dict_CoArbitrary_399)(_464.value0);
            };
            throw new Error("Failed pattern match");
        });
    };
        ...
        return function (__dict_CoArbitrary_401) {
            return new CoArbitrary(function (_463) {
                if (_463 instanceof Data_Either.Left) {
                    return coarbitrary(__dict_CoArbitrary_400)(_463.value0);
                };
                if (_463 instanceof Data_Either.Right) {
                    return coarbitrary(__dict_CoArbitrary_401)(_463.value0);
                };
                throw new Error("Failed pattern match");
            });
        };
    ...
    var coarbArray = function (__dict_CoArbitrary_402) {
        return new CoArbitrary(function (_465) {
            ...
            if (_465.length >= 1) {
                var _1860 = _465.slice(1);
                return Prelude["<<<"](Prelude.semigroupoidArr())(coarbitrary(coarbArray(__dict_CoArbitrary_402))(_1860))(coarbitrary(__dict_CoArbitrary_402)(_465[0]));
            };
            throw new Error("Failed pattern match");
        });
    };
    ...
    var coarbAlphaNumString = function () {
        return new CoArbitrary(function (_461) {
            return coarbitrary(coarbString())(_461);
        });
    };
...
PS.App_Presentables = (function () {
  ...
  ;
    var linker = function (_471) {
        return function (_472) {
            return function (_473) {
                if (_472 instanceof Data_Maybe.Just && _473 instanceof Data_Maybe.Just) {
                    return Prelude["return"](Control_Monad_Eff.monadEff())(linkerImpl(Data_Maybe.Nothing.value)(Data_Maybe.Just.create)(_471)(_472.value0)(_473.value0));
                };
                throw new Error("Failed pattern match");
            };
        };
    };
    var registerPresentables = Presentable_ViewParser.register("Input")(linker("InputLinker"))(Presentable_ViewParser.emptyRegistery);
    return {
...
PS.App_Routes = (function () {
    ...
    var init = function __do() {
        Presentable_Router.route(rs)(Prelude.flip(Presentable_ViewParser.renderYaml)(App_Presentables.registerPresentables))();
        ...
        return function (_475) {
            return function __do() {
                ...
                return Prelude[">>="](Control_Monad_Eff.bindEff())(Prelude[">>="](Control_Monad_Eff.bindEff())(getSocket)(Network_SocketIO.emit("StatQuery")((function () {
                    var _1879 = {};
                    for (var _1880 in _474) {
                        if (_474.hasOwnProperty(_1880)) {
                            _1879[_1880] = _474[_1880];
                        };
                    };
                    _1879.id = uuid;
                    return _1879;
